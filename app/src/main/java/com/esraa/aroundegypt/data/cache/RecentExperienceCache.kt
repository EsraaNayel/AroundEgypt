...
@Entity
data class RecentExperienceCache(
    @PrimaryKey
    val id: String,
...
fun RecentExperienceCache.toExperience(): Experience {
    return Experience(
        id,
        title,
        coverPhoto,
...
fun Experience.toRecentExperienceCache(): RecentExperienceCache {
    return RecentExperienceCache(
        id,
        title,
        cover_photo,
        views_no,
